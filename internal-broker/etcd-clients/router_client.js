...
RouterClient.prototype.add = function(tenantId, targetName, serverUrl, isCloudDevice, cb) {
...
RouterClient.prototype.remove = function(tenantId, targetName, isCloudDevice, cb) {
  if (typeof targetName === 'function') {
    cb = targetName;
    targetName = tenantId;
    tenantId = null;
